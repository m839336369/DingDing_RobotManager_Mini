...
namespace Native.App.Export
{
	...
	{	
		...
		{	
			 ...
			 */	
			if (AppData.UnityContainer.IsRegistered<IMenuCall> ("窗口"))	
			{	
				MenumenuOpenWindowHandler += AppData.UnityContainer.Resolve<IMenuCall> ("窗口").MenuCall;	
			}	
		...
		{	
			...
			{	
				CQMenuCallEventArgs args = new CQMenuCallEventArgs (AppData.CQApi, AppData.CQLog, "窗口", "menuOpenWindow");	
